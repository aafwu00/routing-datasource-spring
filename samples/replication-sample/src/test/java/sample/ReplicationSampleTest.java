...
@Rollback
@DirtiesContext
class ReplicationSampleTest {
    @Autowired
    private WebApplicationContext context;
    @Autowired
    private ReplicationSample.TodoRepository repository;
    private MockMvc mvc;
    ...
    @Test
    void should_be_choose_master_datasource_or_slave_datasource_depend_on_readOnly_property_for_transaction() throws Exception {
